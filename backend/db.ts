...
import { createDatabaseMigrations } from './database/migrations';
...
const { ensureColumn, migrateFloorPlansForMultipleDrawings, syncRegionAssignments } = createDatabaseMigrations(db);
...
export const createSchema = () => {
  ...
  ensureColumn('map_versions', 'render_mode', "TEXT NOT NULL DEFAULT ''");
  ensureColumn('map_versions', 'pdf_object_key', 'TEXT');
  ensureColumn('map_versions', 'manifest_json', 'TEXT');
  ensureColumn('map_versions', 'world_width_points', 'REAL');
  ensureColumn('map_versions', 'world_height_points', 'REAL');
  ensureColumn('map_versions', 'page_count', 'INTEGER');
  ensureColumn('map_versions', 'content_bounds_json', 'TEXT');
  ensureColumn('map_versions', 'pdf_sha256', 'TEXT');
  ensureColumn('map_objects', 'compact_text', "TEXT NOT NULL DEFAULT ''");
  ensureColumn('map_objects', 'page_index', 'INTEGER');
  ensureColumn('map_objects', 'page_x_points', 'REAL');
  ensureColumn('map_objects', 'page_y_points', 'REAL');
  ensureColumn('map_objects', 'world_x_points', 'REAL');
  ensureColumn('map_objects', 'world_y_points', 'REAL');
  ensureColumn('map_objects', 'width_points', 'REAL');
  ensureColumn('map_objects', 'height_points', 'REAL');
